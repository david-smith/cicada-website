...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'cicada',                  # Not used with sqlite3.
        'HOST': 'localhost',                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '5432',                        # Set to empty string for default. Not used with sqlite3.
    },
    'redmine': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'redmine',                      # Or path to database file if using sqlite3.
        'USER': 'redmine',                      # Not used with sqlite3.
        'PASSWORD': 'cicada-redmine',                  # Not used with sqlite3.
        'HOST': 'localhost',                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '5432',                        # Set to empty string for default. Not used with sqlite3.
    },
}
...
COMPRESS_ROOT = os.path.join(PROJECT_ROOT, 'assets/').replace('\\', '/')
